 ...
 */
@Repository // namedParameterJdbcTemplateにDIを注入するアノテーション
class CustomerRepository(val namedParameterJdbcTemplate: NamedParameterJdbcTemplate) : ICustomerRepository {
